...
\begin{align*}
  P(\omega_1 \vert (x, y)) &= \frac{P(x, y \vert \omega_1) P(\omega_1)}{P(x, y)} = \frac{\frac{1}{3\pi} e^{-\frac{x^2 + y^2}{2}}}{\frac{1}{3\pi} e^{-\frac{x^2 + y^2}{2}}+\frac{1}{6\pi} e^{-\frac{(x-2)^2 + (y-2)^2}{2}}}\\
  P(\omega_2 \vert (x, y)) &= \frac{P(x, y \vert \omega_2) P(\omega_2)}{P(x, y)} = \frac{\frac{1}{6\pi} e^{-\frac{(x-2)^2 + (y-2)^2}{2}}}{\frac{1}{3\pi} e^{-\frac{x^2 + y^2}{2}}+\frac{1}{6\pi} e^{-\frac{(x-2)^2 + (y-2)^2}{2}}} \\
\end{align*}
...
\end{align*}
Vice versa, if $\frac{P(\omega_1, x)}{P(\omega_2, x)} \geq \frac{\lambda_2}{\lambda_1}$, then:
\begin{align*}
  \frac{P(\omega_1, x)}{P(\omega_2, x)} &\geq \frac{\lambda_2}{\lambda_1} \\
  \int_x \lambda_2 P(\omega_2, x) \d x &\leq \int_x \lambda_1 P(\omega_1, x) \d x 
\end{align*}
...
\begin{homeworkProblem}
\section*{(1)}
I use Parzen window of width $h=1$ to estimate the density function of P(x, y). The the density function 
...
According the mean density error, the kernel function `Parzen' with window width of $1$ is the best composition.
\begin{figure}[htbp]
  \centering
